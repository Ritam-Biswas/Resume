...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  \textbf{\Huge Ritam Biswas \vspace{2pt}} & % row = 1, col = 1
  Location: Potheri ,Chengalpattu, Chennai \\ % row = 1, col = 2
  \href{https://ritambiswasportfolio.vercel.app/}{\uline{Portfolio}} $|$ % row = 2, col = 1
  \href{https://www.linkedin.com/in/ritambiswas1801/}{\uline{LinkedIn}} $|$ % row = 2, col = 1
  \href{https://github.com/Ritam-Biswas}{\uline{GitHub}} & % row = 2, col = 1
  Email: \href{mailto:ritambiswas1801@gmail.com}{\uline{ritambiswas1801@gmail.com}} $|$ % row = 2, col = 2
  Mobile: 9330043216 \\ % row = 2, col = 2
\end{tabular*}
%--------------------------------------------
